// Seed script: Creates an "Indian History" quiz from the JSON bank.
// Run: npx tsx scripts/_seed-history-quiz.ts
import "dotenv/config";
import { config } from "dotenv";
config({ path: ".env.local", override: true });

import { prisma } from "../src/lib/prisma";
import questions from "./indian-history.json";

const QUIZ_TITLE = "Indian History — Ancient to Independence";
const QUIZ_DESCRIPTION =
  "50 questions spanning the Indus Valley, Mauryas, Guptas, Cholas, Delhi Sultanate, Mughals, Marathas, British Raj, and the Freedom Struggle.";
