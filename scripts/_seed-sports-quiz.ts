// Seed script: Creates an "Indian Sports" quiz from the JSON bank.
// Run: npx tsx scripts/_seed-sports-quiz.ts
import "dotenv/config";
import { config } from "dotenv";
config({ path: ".env.local", override: true });

import { prisma } from "../src/lib/prisma";
import questions from "./indian-sports.json";

const QUIZ_TITLE = "Indian Sports — Cricket, Olympics & Beyond";
const QUIZ_DESCRIPTION =
  "50 questions on Indian cricket legends, World Cups, IPL, Olympics, hockey, badminton, kabaddi, and more!";
