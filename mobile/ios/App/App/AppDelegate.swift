...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // Push Notifications — bridge APNs callbacks to the Capacitor JS layer.
    // Without these two, the `registration` / `registrationError` events
    // never fire in JavaScript and PushNotifications.register() does
    // nothing observable. The exact pattern is from the @capacitor/push-
    // notifications plugin's setup docs.
