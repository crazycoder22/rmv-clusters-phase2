  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
        <Link href={editing ? `/initiatives/${initiativeId}` : "/initiatives"} className="inline-flex items-center gap-1 text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900"><ArrowLeft size={16} /> Back</Link>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-3 mb-6">{editing ? "Edit initiative" : "New initiative"}</h1>
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-5 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">After this time, no one can add feedback or replies (likes stay open).</p>
          </div>
          <div>
